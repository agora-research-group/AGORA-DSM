...
public class RegisterSensorV2 {
	...
	public static boolean send(JSONObject message) {
		...
		try {
			...
			String sensor_id = null, property = null, sensor_name = null, agency = null, timestamp = null, value = null,
					nivel = null, unit = null, type = null, altitude = null, longitude = null, latitude = null,
			...
			if (describeSensor.getResult() == 200) {
				...
				while (i < nodeList.getLength()) {
					if (nodeList.item(i).getFirstChild().getNodeValue()
							.equals(message.get("sensor_id").toString() + "_" + message.get("property").toString()))
						existsProperty = 1;
					i++;
				}
