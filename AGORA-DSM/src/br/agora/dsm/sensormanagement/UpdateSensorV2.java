...
public class UpdateSensorV2 {
	...
	public static boolean send(JSONObject message) throws DOMException, org.apache.http.HttpException {
		...
		try {
			...
			String sensor_id = null, sensor_name = null, agency = null, timestamp = null, value = null, nivel = null,
					unit = null, type = null, altitude = null, longitude = null, latitude = null,
					sensor_place_name = null, info = null;
			...
			if (describeSensor.getResult() == 200) {
				...
				/*
				 * if (message.get("property") != null) { // cria um JSONArray e
				 * preenche com valores string JSONArray observableProperty =
				 * (JSONArray) jsonObject.get("observableProperty");
				 * 
